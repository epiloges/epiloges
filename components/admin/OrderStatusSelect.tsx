    ...
    <div className="inline-flex flex-col items-start gap-1">
      <select
        ...
        onChange={(e) => {
          ...
          const lines = [`Set order to "${ORDER_STATUS_LABEL[next]}"?`, "", ORDER_STATUS_CONSEQUENCE[next]];
          if (next === "shipped" && !hasTracking) {
            lines.push("", "No tracking number is set — the email will not include one.");
          }
